...
![结构型模式](/posts/2018-and-before/20160106091223191.jpg)  

## 6、适配器模式（Adapter）
适配器模式将某个类的接口转换成客户端期望的另一个接口表示，目的是消除由于接口不匹配所造成的类的兼容性问题。主要分为三类：类的适配器模式、对象的适配器模式、接口的适配器模式。

### 6.1 类的适配器模式
![类的适配器模式](/posts/2018-and-before/20160106091415498.jpg)  
...
![对象的适配器模式](/posts/2018-and-before/20160106093157756.jpg)  
只需要修改Adapter类的源码即可：
```java
...
![接口的适配器模式](/posts/2018-and-before/20160106093431314.jpg)  
...
![装饰模式](/posts/2018-and-before/20160106093930452.jpg)  
...
![代理模式](/posts/2018-and-before/20160106094409065.jpg)  
...
![外观模式](/posts/2018-and-before/20160106094706995.jpg)  
```java
public class CPU {
...
![桥接模式](/posts/2018-and-before/20160106095049044.jpg)  
...
![桥接模式总结](/posts/2018-and-before/20160106095421169.jpg)  

## 11、组合模式（Composite）
组合模式有时又叫**部分-整体模式**在处理类似树形结构的问题时比较方便，看看关系图：
![组合模式](/posts/2018-and-before/20160106095539821.jpg)  
```java
...
![享元模式](/posts/2018-and-before/20160106095754345.jpg)  
...
看个例子：
![享元模式例子](/posts/2018-and-before/20160106095920566.jpg)  
数据库连接池代码：
```java
